      ...
      <table class="w-full text-left border-collapse">
        ...
        <tbody class="divide-y divide-slate-200">
          <tr v-if="staffList.length === 0" class="p-20 text-center">
            <td colspan="7" class="py-20 italic text-slate-400">
              No {{ title.includes('Admin') ? 'administrators' : 'staff members' }} found.
            </td>
          </tr>
            ...
            <td class="px-6 py-4 font-bold text-[#103059]">
              <div class="flex flex-col">
                <div class="flex items-center gap-2">
                  ...
                  <span v-if="stf.is_superuser" class="px-1.5 py-0.5 bg-amber-100 text-amber-700 text-[0.55rem] font-black uppercase rounded border border-amber-200">Admin</span>
                  <span v-else class="px-1.5 py-0.5 bg-blue-100 text-blue-700 text-[0.55rem] font-black uppercase rounded border border-blue-200">Staff</span>
                </div>
