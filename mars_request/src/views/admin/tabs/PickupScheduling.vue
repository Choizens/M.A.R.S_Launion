<template>
  <div class="flex flex-col gap-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
      ...
      <button @click="$emit('open-slot-modal')" class="px-6 py-2.5 bg-[#ffca28] text-[#103059] font-black rounded border-2 border-[#103059] hover:bg-white transition-all shadow-md flex items-center gap-2">
        ...
        <div class="flex items-center justify-between mb-8">
          ...
          <div class="flex gap-2">
            <button @click="$emit('prev-month')" class="p-2 hover:bg-slate-100 rounded border transition-colors shadow-sm active:scale-95" title="Previous Month">
              <component :is="ChevronLeftIcon" class="w-5 h-5 text-[#103059]" />
            </button>
            <button @click="$emit('next-month')" class="p-2 hover:bg-slate-100 rounded border transition-colors shadow-sm active:scale-95" title="Next Month">
              <component :is="ChevronRightIcon" class="w-5 h-5 text-[#103059]" />
            </button>
          </div>
        </div>
